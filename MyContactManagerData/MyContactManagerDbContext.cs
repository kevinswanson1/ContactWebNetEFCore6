...
namespace MyContactManagerData
{
	public class MyContactManagerDbContext : DbContext
	{
			...
			: base(options)
		{
			...
			//		Leverage DbContext 'base(options)' inheritance to leverage the builder to get the appsettings.JSON
			//		file and leverage the connection string to the database needed to reference.
		}
